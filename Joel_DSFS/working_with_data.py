...
from Joel_DSFS.linear_algebra import shape, get_row, get_column, make_matrix, \
    vector_mean, vector_sum, dot, magnitude, vector_subtract, scalar_multiply
from Joel_DSFS.stats import correlation, standard_deviation, mean
from Joel_DSFS.probability import inverse_normal_cdf
from Joel_DSFS.gradient_descent import maximize_batch
